...
using CrudAppProject.Models.TokenAuth;
...
{
    public abstract class CrudAppProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CrudAppProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CrudAppProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CrudAppProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CrudAppProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CrudAppProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CrudAppProjectDbContext, Task<T>> func)
        {
            T result;
