...
namespace CrudAppProject.Migrations
{
    ...
    [Migration("20241231134238_Added UserName in  Review tbl")]
    partial class AddedUserNameinReviewtbl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrudAppProject.Categories.Category", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrudAppProject.EmailSender.EmailSenderEntities.EmailTemplate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrudAppProject.EmailSender.EmailSenderEntities.QueuedEmail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrudAppProject.Images.Image", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrudAppProject.ProductReviews.ProductReview", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("CrudAppProject.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("CrudAppProject.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("CrudAppProject.OrderDetails.OrderDetail", b =>
                {
                    b.HasOne("CrudAppProject.Orders.Order", "Order")
            ...
            modelBuilder.Entity("CrudAppProject.ProductReviews.ProductReview", b =>
                {
                    ...
                    b.HasOne("CrudAppProject.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
